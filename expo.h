...
// by returning the exponentiation of the values of the two subexpressions.
...
class Expo: public SubExpression {
public:
    Expo(Expression* left, Expression* right): SubExpression(left, right) {
    }
    double evaluate()  {
